        ...
        <div className="one_playlist">
            <div className='one_playlist_container'>
                <div className='playlistOne'>
                    ...
                    <button className="addSongs" onClick={() => setShowModal(true)}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#cf6b28" className="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
