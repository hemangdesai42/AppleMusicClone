      ...
      <div className='navbar'>
        ...
        <div className='navigation_container'>
          ...
          <div className='library'>Library
            ...
            <br></br>
            <div className='artists'><a href='/artists'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="#cf6b28" className="bi bi-file-person" viewBox="0 0 16 16">
              <path d="M12 1a1 1 0 0 1 1 1v10.755S12 11 8 11s-5 1.755-5 1.755V2a1 1 0 0 1 1-1h8zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4z" />
              <path d="M8 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
            </svg> Artists</a></div>
            <br></br>
            <div className='songs'><a href='/songs'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="#cf6b28" className="bi bi-music-note-beamed" viewBox="0 0 16 16">
              <path d="M6 13c0 1.105-1.12 2-2.5 2S1 14.105 1 13c0-1.104 1.12-2 2.5-2s2.5.896 2.5 2zm9-2c0 1.105-1.12 2-2.5 2s-2.5-.895-2.5-2 1.12-2 2.5-2 2.5.895 2.5 2z" />
              <path fillRule="evenodd" d="M14 11V2h1v9h-1zM6 3v10H5V3h1z" />
              <path d="M5 2.905a1 1 0 0 1 .9-.995l8-.8a1 1 0 0 1 1.1.995V3L5 4V2.905z" />
            </svg> Songs</a></div>
            <br></br>
            <div className='playlists'><a href='/playlists'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="#cf6b28" className="bi bi-music-note-list" viewBox="0 0 16 16">
            ...
            <br></br>
            <div className='upload'><a href='/upload'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="#cf6b28" className="bi bi-upload" viewBox="0 0 16 16">
